...
const Hero = () => {
    return (
        <div className="flex justify-between items-center gap-5 -mt-28 overflow-hidden ">
            ...
            <div className="bg-[url('/bg-intro-desktop.svg')] bg-no-repeat bg-cover relative h-screen w-[1000px] -right-10" >
